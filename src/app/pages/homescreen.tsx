...
export default function HomeScreen() {
  const words = ["Hi! I'm Pratik Mahalle"];
  return (
      ...
      <div className="h-screen w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md">
        ...
        <h3 className="md:text-xl text-sm lg:text-xl font-medium text-center relative z-20 text-gray-400 mt-10 max-w-7xl mb-2 lg:mb-4 pl-8 pr-8">
          <p className="leading-relaxed">
            A <span className="text-white font-medium">Software Engineer</span>{" "}
            specializing in <span className="text-white">DevOps</span> and{" "}
            <span className="text-white">Cloud</span> technologies.
          </p>
          <p className="leading-relaxed">
            ...
            <span className="text-white">writing blogs</span>,{" "}
            <span className="text-white">dedicated to tech community</span>.
          </p>
        </h3>
