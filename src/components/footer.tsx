...
export default function Footer() {
  return (
    <div className="flex bg-black xl:justify-end lg:justify-end md:justify-end xl:pr-8 lg:pr-8 md:pr-8 space-x-8 pt-6 pr-0 justify-center">
      ...
      <div className="relative group">
        <Link
          href="https://www.linkedin.com/in/mahalle-pratik/"
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <div className="relative group">
        <Link
          href="https://twitter.com/pratikmahalle10"
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <div className="relative group">
        <Link
          href="https://instagram.com/pratikmahalle17"
          target="_blank"
          rel="noopener noreferrer"
        >
      ...
      <div className="relative group">
        <Link href="mailto:pratik.mahalle@outlook.com">
